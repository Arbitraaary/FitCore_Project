...
public class UserService : IUserService
{
    ...
    {
        var user = await CreateBaseUserAsync(dto, EUserType.Manager, ct);
    ...
    {
        var user = await CreateBaseUserAsync(dto, EUserType.Coach, ct);

        var coach = new CoachModel
        {
            UserId = user.Id,
            Specialization = dto.Specialization
            //LocationId = managerLocation
        };
    ...
    {
        var user = await CreateBaseUserAsync(dto, EUserType.Client, ct);
